...
public class TrackerConfigController_Deprecated implements Initializable {
    private TrackerController_Deprecated trackerControllerDeprecated = null;
...
//        if (trackerControllerDeprecated != null) {
//            trackerControllerDeprecated.setFocusConfig((int)focusWidth.getValue(), (int)focusHeight.getValue(), (int)focusX.getValue(), (int)focusY.getValue());
//        }
    }
...
//            trackerControllerDeprecated.setRole((byte) 0);
//        } else if (laneRole_combobox.getValue().toString().equals("Only Enter")){
//            trackerControllerDeprecated.setRole((byte) 1);
//        } else if (laneRole_combobox.getValue().toString().equals("Only Out")){
//            trackerControllerDeprecated.setRole((byte) 2);
//        }
//        Stage stage = (Stage) laneRole_combobox.getScene().getWindow();
//        stage.close();
    }
    public void setTrackingController(TrackerController_Deprecated trackingController) {
        this.trackerControllerDeprecated = trackingController;
    }
